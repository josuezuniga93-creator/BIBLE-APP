...
export interface T {
  ...
  preacherSave: string;
  // Translation selector (Feature 3)
  translationLabel: string;
  translationKjv: string;
  translationEsv: string;
  translationGeneva: string;
  // Share / shareable links (Feature 4)
  share: string;
  copied: string;
  sharedAnalysis: string;
  // Streaming (Feature 6)
  stillAnalyzing: string;
  // Preacher tracking (Feature 7)
  historyTabLabel: string;
  preachersTabLabel: string;
  preachersTitle: string;
  sermonsAnalyzed: string;
  noPreachersTracked: string;
  worstVerdict: string;
...
export const TRANSLATIONS: Record<Lang, T> = {
  en: {
    ...
    preachersTabLabel: "Preachers",
    preachersTitle: "Preachers",
    sermonsAnalyzed: "sermons analyzed",
    noPreachersTracked: "No preachers tracked yet.",
  ...
  es: {
    ...
    sharedAnalysis: "Análisis compartido",
    stillAnalyzing: "Aún analizando…",
    historyTabLabel: "Historial",
    preachersTabLabel: "Predicadores",
    preachersTitle: "Predicadores",
    sermonsAnalyzed: "sermones analizados",
    noPreachersTracked: "Aún no hay predicadores rastreados.",
